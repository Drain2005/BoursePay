        ...
        try (Connection conn = getConnection();
            ...
            stmt.executeUpdate("""
                CREATE TABLE IF NOT EXISTS ETUDIANT (
                    ...
                    FOREIGN KEY (idniv) REFERENCES MONTANT(idniv)
                )
            """);
            
            // Créer la table PAYER
            stmt.executeUpdate("""
                CREATE TABLE IF NOT EXISTS PAYER (
                    ...
                    FOREIGN KEY (matricule, annee_univ) REFERENCES ETUDIANT(matricule, annee_univ)
                )
            """);
